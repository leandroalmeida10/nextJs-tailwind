        ...
        <div className="container px-4 mx-auto">
          <div className="pt-4 bg-white shadow rounded">
            <div className="flex px-6 pb-3 border-b">
              <h3 className="text-xl font-bold">Histórico de consumos</h3>
            </div>
            <div className="block px-6 pb-4 border-b pt-2">
              <p className="pb-2">
                Total de consultas gratuitas:
                <span className="font-bold pl-1">650</span>
              </p>
              <p className="pb-2">
                Total de consultas pagas:
                <span className="font-bold pl-1">250</span>
              </p>
              <p className="pb-2">
                Base total de valor:
                <span className="font-bold pl-1">R $ 6,50</span>
              </p>
              <p className="pb-2">
                Total de consumo:
                <span className="font-bold pl-1">R $ 1,50</span>
              </p>
              <p>
                Total de valor final:
                <span className="font-bold pl-1">R $ 5,00</span>
              </p>
            </div>
              ...
              <table className="table-auto w-full">
                <thead>
                  <tr className="text-xs text-gray-500 text-left">
                    <th className="pb-3 font-medium" contentEditable="false">
                      Data de consumo
                    </th>
                    <th className="pb-3 font-medium" contentEditable="false">
                      Escopo
                ...
                <tbody>
                  <tr className="text-xs bg-gray-50">
                    <td className="py-5 px-6 font-medium">20/04/2023</td>
                    <td className="font-medium">P.J</td>
                    <td className="font-medium">Datav1 básico ( PT-BR )</td>
                    <td className="font-medium">130</td>
                    <td className="font-medium">50</td>
                    <td className="font-medium">R $ 130,00</td>
                    <td className="font-medium">R $ 0,30</td>
                    <td className="font-medium">R $ 1,00</td>
                  </tr>
                  <tr className="text-xs">
                    <td className="py-5 px-6 font-medium">20/04/2023</td>
                    <td className="font-medium">P.F</td>
                    <td className="font-medium">Datav1 básico ( PT-BR )</td>
                    <td className="font-medium">130</td>
                    <td className="font-medium">50</td>
                    <td className="font-medium">R $ 130,00</td>
                  ...
                  <tr className="text-xs bg-gray-50">
                    <td className="py-5 px-6 font-medium">20/04/2023</td>
                    <td className="font-medium">Veículos</td>
                    <td className="font-medium">Datav1 básico ( PT-BR )</td>
                    <td className="font-medium">130</td>
                    <td className="font-medium">50</td>
                    <td className="font-medium">R $ 130,00</td>
                  ...
                  <tr className="text-xs bg-gray-50">
                    <td className="py-5 px-6 font-medium">20/04/2023</td>
                    <td className="font-medium">Endereço</td>
                    <td className="font-medium">Datav1 básico ( PT-BR )</td>
                    <td className="font-medium">130</td>
                    <td className="font-medium">50</td>
                    <td className="font-medium">R $ 130,00</td>
              ...
              <div className="text-center mt-5">
                ...
                >
                  <span className="inline-block mr-2">
                    <svg
                      className="text-indigo-400 h-3 w-3"
                      viewBox="0 0 12 14"
                      fill="none"
